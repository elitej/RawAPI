        ...
        <c:forEach items="${restaurantList}" var="restaurant">
            <div class="row">
                <div class="rest-content clearfix">
                    <%--<a href="${pageContext.request.contextPath}/restaurant-info/${restaurant.id}">--%>
                        <a href="<c:url value="restaurant-info/${restaurant.id}"/>">
                        <div class="image col-xs-5 pull-left">
                            <img src="<c:url value = "/upload_screen/${restaurant.image}"/>" alt="" width="450px" height="250px">
                        </div>
                    </a>
